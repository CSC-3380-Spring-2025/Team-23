...
--Events
local NPCAttack = BridgeNet2.ReferenceBridge("NPCAttack")

local function MakeMenu(Self)
    local Enemy = Self.__Enemy
    local FriendlyNPCs = Self.__FriendlyNPCs
...
function EnemyOverheadMenu.new(MenuName, Enemy, FriendlyNPCs)
