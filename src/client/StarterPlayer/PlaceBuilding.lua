		...
		if acitonName == "PlaceBuilding" and inputState == Enum.UserInputState.Begin then
			...
			if canPlace then
				...
				if buildingPosition then			
					...
					--in the furute, this building should have an proximity script that creates an instance of a class that handles building progress where user adds resources to complete buildilng. 
